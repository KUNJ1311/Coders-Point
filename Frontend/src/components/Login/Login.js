	...
	return (
		<>
			<div style={{ height: "100vh", width: "100vw", display: "flex" }}>
				<img className="bcg-img" src={bcg} alt="" />
				<Link to="/">
					<img src={coders} width="179px" height="55px" alt="" style={{ zIndex: 999, display: "flex", position: "absolute", top: "7px", left: "34px" }} />
				</Link>
				<section className="sec">
					<div className={`container ${isActive ? "right-panel-active" : ""}`} id="container">
						...
						<div className="overlay-container" id="overlayCon">
							...
							<button ref={overlayBtnRef} className={`overlayBtn`} onClick={togglePanel} id="overlayBtn"></button>
						</div>
					</div>
				</section>
			</div>
