    ...
    <>
      ...
      <div className={"groups " + (mode ? "" : "groups-dark")}>
        <div style={{ paddingTop: "12px" }}>
          {/* Home */}
          <div
            className="d-flex align-c justify-c mb-2"
            width="48px"
            height="48px"
          >
            <div height="48px">
            ...
            <div
              ...
              className="d-flex align-c justify-c cursor-pointer round"
              onMouseEnter={handleMouseEnterlogo}
              onMouseLeave={handleMouseLeavelogo}
              onClick={handleProfileClick}
            >
              <img
                className="d-flex object-cover round-effect"
                style={mystyle}
                src="https://cdn.discordapp.com/avatars/715429945295372329/a977e19af9bf390800ab713f57edb7a1.webp"
                width="48px"
                height="48px"
                alt=""
              />
            ...
            {groups.map((group, index) => (
              <div key={index} width="48px" height="48px" className="servers">
                <div
                  ...
                  className="cursor-pointer d-flex align-c justify-c mb-2 "
                  width="48px"
                  height="48px"
                >
                  <Tooltip
                    id="tooltip"
                    anchorSelect="#groups-tooltip"
                    place="right"
                    style={{ fontSize: "15px" }}
          ...
          <div className="d-flex flex-col w-full align-c">
            <div
              ...
              width="48px"
              height="48px"
              className="mb-2 cursor-pointer groups-svg-border"
            >
              <svg
                className="d-flex object-cover round plus-svg"
                fill="#249c57"
                width="48px"
                height="48px"
