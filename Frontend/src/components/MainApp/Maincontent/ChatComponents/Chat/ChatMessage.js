  ...
  return (
    <>
      {message.messages.map((msg, index) => (
        <li
          className={"chat-list-item " + (mode ? "" : "darkwhite")}
          key={index}
        >
          {index === 0 ? (
            <div className={"chat-list-user " + (mode ? "" : "darkwhite")}>
              <div className="chat-data">
                <img
                  src="https://cdn.discordapp.com/avatars/715429945295372329/a977e19af9bf390800ab713f57edb7a1.webp?size=100"
                  className="chat-data-avatar"
                  alt=""
                ></img>
                <h3 className="chat-data-header">
                  ...
                  <span
                    className={"chat-timestamp " + (mode ? "" : "darkfont")}
                    id="chat-timestamp-tooltip"
                    data-tooltip-content={formatDateTime(msg.timestamp)}
              ...
              >
                <span className="chat-small-timestamp">
                  ...
                  >
                    <i
                      className={
                        "timestamp-separator " + (mode ? "" : "darkfont")
                      }
                      aria-hidden="true"
                    >
                      [
