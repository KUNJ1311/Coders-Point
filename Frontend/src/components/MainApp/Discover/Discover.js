          ...
          <li className="channels">
            <div className="cursor-pointer wrapperCommon">
              <div
                ...
                onClick={handleHideChannelsText}
              >
                <svg
                  style={{
                    transform: `rotate(${hiddenText ? "-90deg" : "0"})`,
                  }}
                  className="arrow-svg"
                  width="24"
                  height="24"
          ...
          {text.map((text, textindex) => (
            ...
            >
              <div className="chat-channels ">
                <div
                  className={"chat-channels-2 " + (mode ? "" : "discover-col")}
                >
                  <Link to="/channels/testing/" className="link-channels ">
                    ...
                    <div
                      className={"channels-list " + (mode ? "" : "darkfont")}
                    >
                      {text}
                    </div>
                  </Link>
          ...
          <li className="channels">
            <div className="cursor-pointer wrapperCommon">
              <div className="channels-content" onClick={handleHideChannelsVC}>
                <svg
                  style={{ transform: `rotate(${hiddenVC ? "-90deg" : "0"})` }}
                  className="arrow-svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
        ...
        <ul className="ul-discover">
          <li className="channels">
            <div className="cursor-pointer wrapperCommon">
              <div
                className="channels-content"
                onClick={handleHideChannelsProject}
              >
                <svg
                  style={{
                    transform: `rotate(${hiddenProject ? "-90deg" : "0"})`,
                  }}
                  className="arrow-svg"
                  width="24"
                  height="24"
          ...
          {project.map((project, projectindex) => (
            <li
              key={projectindex}
              style={{ position: "relative" }}
              className={hiddenProject ? "hidden" : ""}
            >
              <div className="chat-channels">
                <div
                  className={"chat-channels-2 " + (mode ? "" : "discover-col")}
