	...
	let message = {
		...
		html: `
			<html>
				...
				<body style="background-color: #f2f2f2; font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
									...
									<tr>
										<td style="background-color: #fff; padding: 50px 20px;">
											<table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
												...
												<tr>
													<td style="text-align: center; font-size: 20px; font-weight: 500;">One Time Password</td>
												</tr>
												<tr>
													<td style="text-align: center; font-family: 'Courier New', Courier, monospace; font-weight: 800; font-size: 40px; letter-spacing: 10px; padding: 20px 0;">${text}</td>
												</tr>
												<tr>
													<td style="text-align: center; font-size: 16px; color: gray; padding: 20px 0;">If you did not make this request, just ignore this email.</td>
												</tr>
											</table>
										</td>
									</tr>
