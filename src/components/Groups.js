			...
			<div style={{ paddingTop: "12px" }}>
				...
				<div className="d-flex align-c justify-c mb-2" width="48px" height="48px">
					<div height="48px">
						<div className="side-line">
							<span className="side-line-effect"></span>
						</div>
					</div>
					<div className="d-flex align-c justify-c cursor-pointer groups-border home-logo">
				...
				<div className="d-flex flex-col w-full align-c ">
					{groups.map((group, index) => (
						<div key={index} width="48px" height="48px" className="mb-2 cursor-pointer servers">
